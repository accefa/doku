...
\end{figure}
Die Bälle werden durch ein rotierendes Drehrad beschleunigt. Das Drehrad wiederum erhält seine Rotation durch einen angebauten Keilriemen (oder Zahnriemen), welcher mit einem Motor verbunden ist. Ein über dem Rad angebrachtes Metallband dient dazu, Grössenunterschiede der Bälle zu kompensieren.
\begin{figure}[h!]
	\centering
...
\begin{figure}[h!]
	...
	\caption{Ausrichtvorrichtung Seitlich}
\end{figure}
